...
const deals = [
  ...
  },
  {
    ...
    thumb: "https://images.unsplash.com/photo-1548013146-72479768bada?w=120&auto=format&fit=crop",
    badge: "07 Days Deal",
  ...
  },
  {
    ...
    thumb: "https://images.unsplash.com/photo-1507525428034-b723cf961d3e?w=120&auto=format&fit=crop",
    badge: "Hot Deal",
  ...
  },
  {
    ...
    thumb: "https://images.unsplash.com/photo-1559592413-7cec4d0cae2b?w=120&auto=format&fit=crop",
    badge: "Weekend",
                  ...
                  <AnimatePresence mode="wait">
                    {subMode === "color" ? (
                      <motion.div
                        ...
                        className={`rounded-2xl overflow-hidden h-52 ${deal.flatColor} flex flex-col relative`}
                      >
                        <div className="absolute top-3 right-3 w-14 h-14 rounded-xl overflow-hidden shadow-lg border-2 border-white/30">
                          <img src={deal.thumb} alt={deal.destination} className="w-full h-full object-cover" />
                        </div>
                        <div className="flex-1 flex items-start px-5 pt-5 pr-20">
                          <div>
                            ...
                            <p className="text-white/75 text-sm mt-0.5 leading-snug">{deal.tagline}</p>
                          </div>
                        </div>
                      ...
                      >
                        ...
                        <div className="absolute top-3 right-3 w-14 h-14 rounded-xl overflow-hidden shadow-lg border-2 border-white/40">
                          <img src={deal.thumb} alt={deal.destination} className="w-full h-full object-cover" />
                        </div>
