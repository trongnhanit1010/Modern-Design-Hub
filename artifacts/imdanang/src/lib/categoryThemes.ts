...
export const categoryThemes: Record<CategoryKey, CategoryTheme> = {
  ...
  cyclo:         { key: "cyclo",         label: "Xích lô du lịch",      href: "/xich-lo-du-lich",     icon: Bike,            iconColor: "text-teal-700",    activeBg: "bg-teal-50",        hex: "#0f766e", gradient: "from-teal-700 via-teal-600 to-teal-500" },
