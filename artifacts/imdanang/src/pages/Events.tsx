...
import {
  ...
  Radio, Users, ArrowRight, Flame, Tag, Sparkles,
} from "lucide-react";
...
const ALL_EVENTS: EventItem[] = [
  { id: 1, name: "Lễ hội Pháo hoa Quốc tế Đà Nẵng 2026", category: "festival", status: "live", startDate: "2026-04-04", endDate: "2026-04-28", time: "21:00 – 22:00", location: "Cầu Rồng & Cầu Sông Hàn", image: "https://images.unsplash.com/photo-1533294455009-a77b7557d2d1?w=1200&auto=format&fit=crop", desc: "Sự kiện pháo hoa quốc tế lớn nhất Đông Nam Á với hơn 10 quốc gia trình diễn.", price: "Miễn phí", attendees: 120000, gradient: "from-violet-700 via-indigo-700 to-blue-700" },
  { id: 2, name: "Đêm Nhạc Acoustic Sông Hàn", category: "music", status: "live", startDate: "2026-04-01", endDate: "2026-04-30", time: "19:30 – 22:00", location: "Bờ Tây Sông Hàn", image: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=1200&auto=format&fit=crop", desc: "Âm nhạc acoustic mỗi tối cuối tuần bên bờ sông Hàn thơ mộng.", price: "Miễn phí", attendees: 3000, gradient: "from-teal-700 via-emerald-700 to-green-700" },
  { id: 3, name: "Triển lãm Ảnh Đà Nẵng Xưa & Nay", category: "culture", status: "live", startDate: "2026-04-10", endDate: "2026-04-30", time: "08:00 – 17:00", location: "Bảo tàng Điêu khắc Chăm", image: "https://images.unsplash.com/photo-1536924430914-91f9e2041b83?w=1200&auto=format&fit=crop", desc: "Hơn 200 bức ảnh lịch sử ghi lại cuộc sống Đà Nẵng qua các thập kỷ.", price: "30.000đ", attendees: 5000, gradient: "from-amber-700 via-orange-700 to-red-700" },
  { id: 4, name: "Festival Biển Đà Nẵng 2026", category: "festival", status: "upcoming", startDate: "2026-05-15", endDate: "2026-05-20", time: "18:00 – 23:00", location: "Bãi biển Mỹ Khê", image: "https://images.unsplash.com/photo-1559339352-11d035aa65de?w=1200&auto=format&fit=crop", desc: "Lễ hội biển lớn nhất với thể thao, âm nhạc, ẩm thực và trình diễn ánh sáng.", price: "Miễn phí", attendees: 50000, gradient: "from-sky-700 via-blue-700 to-indigo-700" },
  { id: 5, name: "Lễ hội Ẩm thực Phố Cổ Hội An", category: "food", status: "upcoming", startDate: "2026-05-20", endDate: "2026-05-22", time: "09:00 – 22:00", location: "Phố Cổ Hội An", image: "https://images.unsplash.com/photo-1555396273-367ea4eb4db5?w=1200&auto=format&fit=crop", desc: "Hội tụ ẩm thực 3 miền với hơn 500 gian hàng và workshop nấu ăn.", price: "Miễn phí vào cửa", attendees: 30000, gradient: "from-orange-700 via-red-700 to-rose-700" },
  { id: 6, name: "Danang Music Festival 2026", category: "music", status: "upcoming", startDate: "2026-06-06", endDate: "2026-06-07", time: "20:00 – 24:00", location: "Công viên APEC", image: "https://images.unsplash.com/photo-1501386761578-eaa54b7f791e?w=1200&auto=format&fit=crop", desc: "Liên hoan âm nhạc quy tụ các nghệ sĩ hàng đầu Việt Nam và quốc tế.", price: "350.000đ", attendees: 20000, gradient: "from-violet-700 via-purple-700 to-fuchsia-700" },
  { id: 7, name: "Hội chợ Di sản Miền Trung", category: "culture", status: "upcoming", startDate: "2026-07-10", endDate: "2026-07-15", time: "08:00 – 21:00", location: "Trung tâm Triển lãm", image: "https://images.unsplash.com/photo-1548013146-72479768bada?w=1200&auto=format&fit=crop", desc: "Giới thiệu di sản văn hóa, nghề thủ công và ẩm thực miền Trung.", price: "50.000đ", attendees: 15000, gradient: "from-amber-700 via-yellow-700 to-lime-700" },
  { id: 8, name: "Lễ Vu Lan Báo Hiếu 2026", category: "culture", status: "upcoming", startDate: "2026-08-08", endDate: "2026-08-09", time: "Cả ngày", location: "Các chùa lớn Đà Nẵng", image: "https://images.unsplash.com/photo-1545579133-99bb5ab189bd?w=1200&auto=format&fit=crop", desc: "Nghi lễ truyền thống tại các ngôi chùa lớn, thả hoa đăng trên sông Hàn.", price: "Miễn phí", attendees: 40000, gradient: "from-rose-700 via-pink-700 to-fuchsia-700" },
];
...
const collage = [
  { src: "https://images.unsplash.com/photo-1533294455009-a77b7557d2d1?w=900&auto=format&fit=crop", className: "top-0 right-0 w-[58%] h-[58%]" },
  { src: "https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?w=900&auto=format&fit=crop", className: "top-[18%] left-0 w-[48%] h-[52%]" },
  { src: "https://images.unsplash.com/photo-1536924430914-91f9e2041b83?w=900&auto=format&fit=crop", className: "bottom-0 right-[10%] w-[52%] h-[42%]" },
];
...
function MiniCalendar({
  year, month, events, selectedDay, onSelectDay, onPrev, onNext, accent,
}: {
  year: number; month: number; events: EventItem[];
  selectedDay: number | null; onSelectDay: (d: number | null) => void;
  onPrev: () => void; onNext: () => void;
  accent: { orbA: string; orbB: string; orbC: string };
}) {
...
/* ─── Upcoming Card ─── */
function UpcomingCard({ ev, index, isInView, accent }: { ev: EventItem; index: number; isInView: boolean; accent: { orbA: string; orbB: string; orbC: string } }) {
  const Icon = CAT_ICON[ev.category];
...
export default function Events() {
  ...
  const acc = useThemeAccents("events");
  ...
  return (
    <CategoryShell
      ...
      stats={[
        ...
        { icon: Sparkles,     label: "Tổng 2026",  value: `${ALL_EVENTS.length}` },
      ]}
      collage={collage}
      floatingBadge={{ icon: Flame, title: "26.04 · Pháo hoa QT", subtitle: "★ TONIGHT · 21:00" }}
      search={search}
      setSearch={setSearch}
      searchPlaceholder="Tìm sự kiện, lễ hội, địa điểm..."
      ...
      <section className="pt-2">
        ...
        <div className="overflow-hidden" ref={liveEmblaRef}>
          <div className="flex gap-4">
            {liveEvents.map((ev) => <LiveCard key={ev.id} ev={ev} accent={acc} />)}
          </div>
        </div>
      </section>
          ...
          >
            {filteredUpcoming.length === 0 ? (
              ...
              filteredUpcoming.map((ev, i) => (
                <UpcomingCard key={ev.id} ev={ev} index={i} isInView={upcomingInView} accent={acc} />
              ))
            )}
          </motion.div>
        </AnimatePresence>
